...
public class PubsubResource {
    ...
    public String triggerSendEvent2Topic1() {
        ...
        dapr.publishEvent("jetstream-pubsub", "topic1", content.getBytes(StandardCharsets.UTF_8),
                new HashMap<>());
    ...
    @POST
    @Path("/topic2")
    @Topic(name = "topic2", pubsubName = "jetstream-pubsub")
    ...
    @POST
    @Path("/topic3")
    @Topic(name = "topic3", pubsubName = "jetstream-pubsub")
    ...
    @POST
    @Path("/topic4")
    @Topic(name = "topic4", pubsubName = "jetstream-pubsub")
