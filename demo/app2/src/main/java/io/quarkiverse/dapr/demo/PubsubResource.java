...
public class PubsubResource {
    ...
    public String eventOnTopic1(String content) {
        ...
        dapr.publishEvent("jetstream-pubsub", "topic2", content.getBytes(StandardCharsets.UTF_8),
                new HashMap<>());
        System.out.println("App1 sent event to topic2 with content=" + content);

        content = "content" + "-app3";
        dapr.publishEvent("jetstream-pubsub", "topic3", content.getBytes(StandardCharsets.UTF_8),
                new HashMap<>());
        ...
        dapr.publishEvent("jetstream-pubsub", "topic4", testData,
                new HashMap<>());
